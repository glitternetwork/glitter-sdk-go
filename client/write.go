...
func (lcd *LCDClient) CreateDataset(ctx context.Context, datasetName string, workStatus chaindepindextype.ServiceStatus, hosts string, manageAddresses string, description string, duration int64) (*sdk.TxResponse, error) {
...
func (lcd *LCDClient) EditDataset(ctx context.Context, datasetName string, workStatus chaindepindextype.ServiceStatus, hosts string, manageAddresses string, description string) (*sdk.TxResponse, error) {
